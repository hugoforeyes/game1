#!/usr/bin/env python3
"""Extract the modular notification UI kit from its generated component sheet."""
...
SOURCE = ROOT / "assets/ui/notification_v1/component_sheet_alpha.png"
OUTPUT = ROOT / "assets/ui/notification_v1/components"

COLS = (0, 313, 627, 940, 1254)
ROWS = (0, 300, 570, 775, 995, 1254)

ASSETS = {
    "gold_corner_tl": ((0, 0), (48, 48)),
    "gold_corner_tr": ((1, 0), (48, 48)),
    "gold_corner_bl": ((2, 0), (48, 48)),
    "gold_corner_br": ((3, 0), (48, 48)),
    "cyan_corner_tl": ((0, 1), (48, 48)),
    "cyan_corner_tr": ((1, 1), (48, 48)),
    "cyan_corner_bl": ((2, 1), (48, 48)),
    "cyan_corner_br": ((3, 1), (48, 48)),
    "gold_edge_horizontal": ((0, 2), (72, 2)),
    "gold_edge_vertical": ((1, 2), (2, 48)),
    "cyan_edge_horizontal": ((2, 2), (72, 2)),
    "cyan_edge_vertical": ((3, 2), (2, 48)),
    "panel_fill": ((0, 3), (16, 16)),
    "gold_header_divider": ((1, 3), (120, 6)),
    "cyan_header_divider": ((2, 3), (120, 6)),
    "sparkle": ((3, 3), (20, 20)),
    "icon_new_quest": ((0, 4), (32, 32)),
    "icon_new_objective": ((1, 4), (32, 32)),
    "gold_flare": ((2, 4), (144, 18)),
    "cyan_flare": ((3, 4), (144, 18)),
}

STRETCH_TO_BOUNDS = {
    "gold_edge_horizontal", "gold_edge_vertical",
    "cyan_edge_horizontal", "cyan_edge_vertical",
    "panel_fill", "gold_header_divider", "cyan_header_divider",
    "gold_flare", "cyan_flare",
}
...
def main() -> None:
    ...
    for name, (cell, size) in ASSETS.items():
        ...
        if name.endswith("edge_horizontal"):
